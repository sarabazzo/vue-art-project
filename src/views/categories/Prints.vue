<template>
  <div class="prints">
    ...
    <p class="see-also">
      ...
      <router-link to="/drawings" class="item">Drawings</router-link>   
    </p>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    mounted() {
      fetch('https://www.rijksmuseum.nl/api/nl/collection?key=4MZu3ZFk&p=1&ps=10&imgonly=True&q=landschap&type=prent')
        .then(res => res.json())
